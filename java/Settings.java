...
class Settings {
    ...
    public void print() {
        ...
        System.out.println("Авторасстановка бомб: " + (this.autoBombs ? "Вкл" : "Выкл"));
        System.out.println("Звуки: " + (this.sounds ? "Вкл" : "Выкл"));
...
public void inputSettings(Scanner scanner) {
    ...
    public boolean getAutoBombs() { return this.autoBombs; }
    public boolean getSounds() { return this.sounds; }
